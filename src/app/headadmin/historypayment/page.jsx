...
//           id: doc.id,
//           ...doc.data(),
//           pesanan: Array.isArray(doc.data().pesanan) ? doc.data().pesanan : [], // Pastikan pesanan adalah array
//         }));
//         setTransactions(data);
//       } catch (error) {
//         console.error("Error fetching transactions:", error);
...
//   // Fetch Riwayat Transaksi Custome
//   useEffect(() => {
//     const fetchTransactionsCustome = async () => {
//       try {
//         const querySnapshot = await getDocs(collection(db, "jangkauanCustomSewa"));
...
//         <h1 className="text-3xl font-bold text-blue-700 mb-6 text-center">Riwayat Transaksi</h1>

//         {transactions.length === 0 ? (
//           <p className="text-center text-lg text-gray-500">Belum ada transaksi.</p>
//         ) : (
...
//                   <th className="py-2 px-4 border-b">Pesanan</th>
//                   <th className="py-2 px-4 border-b">Status</th>
//                   <th className="py-2 px-4 border-b">Status Mutasi</th>
//                 </tr>
//               </thead>
//               <tbody>
//                 {transactions.map((transaction) => (
...
//                     <td className="py-2 px-4 border-b">{transaction.userName || "Tidak Diketahui"}</td>
//                     <td className="py-2 px-4 border-b">
//                       {new Date(transaction.timeStamp?.toDate()).toLocaleString() || "N/A"}
//                     </td>
//                     <td className="py-2 px-4 border-b">
//                       {transaction.pesanan.length > 0 ? (
//                         transaction.pesanan.map((item, index) => (
//                           <p key={index}>
...
//                       )}
//                     </td>
//                     <td className="py-2 px-4 border-b">{transaction.status || "Belum Disetujui"}</td>
//                     <td className="py-2 px-4 border-b">{transaction.statusMutasi || "N/A"}</td>
//                   </tr>
//                 ))}
//               </tbody>
//             </table>
...
//         <h1 className="text-3xl font-bold text-blue-700 mb-6 text-center">Riwayat Transaksi Custome</h1>

//         {transactionsCustome.length === 0 ? (
//           <p className="text-center text-lg text-gray-500">Belum ada transaksi custome.</p>
//         ) : (
...
//                 <tr className="bg-blue-700 text-white">
//                   <th className="py-2 px-4 border-b">Order ID</th>
//                   <th className="py-2 px-4 border-b">Nama Pemesan</th>
//                   <th className="py-2 px-4 border-b">Deskripsi</th>
//                   <th className="py-2 px-4 border-b">Status</th>
//                   <th className="py-2 px-4 border-b">Awal Pemasangan</th>
//                   <th className="py-2 px-4 border-b">Akhir Pemasangan</th>
//                   <th className="py-2 px-4 border-b">Jangkauan</th>
//                   <th className="py-2 px-4 border-b">Harga</th>
//                 </tr>
//               </thead>
//               <tbody>
//                 {transactionsCustome.map((transaction) => (
//                   <tr key={transaction.id} className="text-center">
//                     <td className="py-2 px-4 border-b">{transaction.judul}</td>
//                     <td className="py-2 px-4 border-b">{transaction.namaPembeli}</td>
//                     <td className="py-2 px-4 border-b">{transaction.deskripsi}</td>
//                     <td className="py-2 px-4 border-b">{transaction.statusCustome}</td>
//                     <td className="py-2 px-4 border-b">{transaction.startDate}</td>
//                     <td className="py-2 px-4 border-b">{transaction.endDate}</td>
//                     <td className="py-2 px-4 border-b">{transaction.jangkauanCustome}</td>
//                     <td className="py-2 px-4 border-b">{transaction.harga}</td>
//                   </tr>
//                 ))}
//               </tbody>
//             </table>
